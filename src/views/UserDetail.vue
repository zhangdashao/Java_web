<template>
  <div class="report-list" v-loading="loadSign">
    <bg-title title="文件上传记录"></bg-title>
    <padding-wrapper>
      <search-wrapper>
        <search-bar :searchForm="selectParams" @search-file="search" role='user' :waste=false @reset-form-file="resetSearch"></search-bar>
      </search-wrapper>
      <mini-wrapper>
