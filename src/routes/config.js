export default {
    menus: [    // 菜单相关路由
        ...
        {
            key: '/app/filesmanage', title: '文件管理', icon: 'rocket',
            subs: [
                { key: '/app/filesmanage/filesList', title: '文件管理列表', component: 'FilesList' },
                { key: '/app/filesmanage/uploadFile', title: '上传文件', component: 'UploadFile' },
                { key: '/app/filesmanage/wasteBox', title: '垃圾箱', component: 'WasteBox' },
                { key: '/app/filesmanage/HospitalList', title: '医院列表', component: 'HospitalList' },
            ],
        },
        { key: '/app/setting/info', title: '个人设置', icon: 'setting', component: 'Setting' },
        // {
