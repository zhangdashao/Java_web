...
class WasteBox extends React.Component {
  ...
  render() {
    return (
      <div className="gutter-example">
        <BreadcrumbCustom first="文件管理" second="垃圾箱" />
        <SearchBar status="waste" handleSearchOption={(type, data) => this.handleSearchOption(type, data)} />
